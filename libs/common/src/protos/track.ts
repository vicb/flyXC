// @generated by protobuf-ts 2.11.1 with parameter long_type_number,force_optimize_code_size
...
class TrackGroup$Type extends MessageType<TrackGroup> {
  constructor() {
    super('TrackGroup', [
      { no: 2, name: 'tracks', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => Track },
    ]);
  }
}
/**
...
class GroundAltitudeGroup$Type extends MessageType<GroundAltitudeGroup> {
  constructor() {
    super('GroundAltitudeGroup', [
      { no: 1, name: 'ground_altitudes', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroundAltitude },
    ]);
  }
}
/**
...
class AirspacesGroup$Type extends MessageType<AirspacesGroup> {
  constructor() {
    super('AirspacesGroup', [
      { no: 1, name: 'airspaces', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => Airspaces },
    ]);
  }
}
/**
...
class MetaTrackGroupsAndRoute$Type extends MessageType<MetaTrackGroupsAndRoute> {
  constructor() {
    super('MetaTrackGroupsAndRoute', [
      { no: 1, name: 'meta_track_groups', kind: 'message', repeat: 2 /*RepeatType.UNPACKED*/, T: () => MetaTrackGroup },
