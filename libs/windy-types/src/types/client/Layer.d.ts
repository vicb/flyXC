 ...
 */
export type Layers = 'capAlerts' | 'pressureIsolines' | 'ghIsolines' | 'tempIsolines' | 'deg0Isolines' | 'windParticles' | 'ecmwfWindParticles' | 'ecmwfWindParticles150h' | 'ecmwfWindParticles500h' | 'ecmwfWindParticles600h' | 'waveParticles' | 'waveParticlesWaves' | 'currentParticles' | 'currentsTideParticles' | 'wind' | 'temp' | 'wetbulbtemp' | 'solarpower' | 'wavePower' | 'uvindex' | 'dewpoint' | 'gust' | 'gustAccu' | 'rh' | 'pressure' | 'ccl' | 'rain' | 'ptype' | 'thunder' | 'clouds' | 'lclouds' | 'mclouds' | 'hclouds' | 'cape' | 'cbase' | 'fog' | 'snowAccu' | 'rainAccu' | 'waves' | 'wwaves' | 'swell1' | 'swell2' | 'swell3' | 'swell' | 'currents' | 'currentsTide' | 'sst' | 'visibility' | 'snowcover' | 'cloudtop' | 'deg0' | 'cosc' | 'dustsm' | 'radar' | 'satellite' | 'gtco3' | 'pm2p5' | 'no2' | 'aod550' | 'tcso2' | 'go3' | 'gh' | 'efiWind' | 'efiTemp' | 'efiRain' | 'moistureAnom40' | 'moistureAnom100' | 'drought40' | 'drought100' | 'soilMoisture40' | 'soilMoisture100' | 'fwi' | 'dfm10h' | 'dfm100h' | 'dfm1000h' | 'turbulence' | 'icing' | 'topoMap' | 'aqi' | 'avalancheDanger';
