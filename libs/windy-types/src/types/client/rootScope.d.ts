 ...
 */
export declare const globalProducts: readonly ["gfs", "ecmwf", "ecmwfAnalysis", "radar", "ecmwfWaves", "gfsWaves", "icon", "capAlerts", "avalancheDanger", "cams", "efi", "satellite", "cmems", "drought", "fireDanger", "activeFires", "topoMap"];
/**
...
export declare const pollenProducts: Record<keyof PollenDataHash2, [
