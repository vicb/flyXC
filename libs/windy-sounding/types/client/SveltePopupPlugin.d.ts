...
export type SveltePopupPluginInitParams<P extends keyof SveltePopupPlugins> = Omit<WindowPluginInitParams<P>, 'ident'> &
  Pick<SveltePopupPlugin<P>, 'ident'> &
  Partial<SveltePopupPlugin<P>>;
/**
