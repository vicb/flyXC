...
import type {
  IncludeInFragmentQueryString,
  IncludeInQueryString,
  AirQDataHash2,
 ...
 */
export declare const getPointForecastData: <K extends DataHash2 | AirQDataHash2 = DataHash2>(
  model: PointProducts,
  { lat, lon, step, days: requiredDays, source }: PointForecastOptions,
  includeInQueryString?: IncludeInQueryString | undefined | null,
  httpOptions?: HttpOptions,
) => Promise<http.HttpPayload<WeatherDataPayload2<K>>>;
 ...
 */
export declare const getDetailPointForecastData: (
  options: DetailPointForecastOptions,
) => Promise<HttpPayload<WeatherDataPayload2<AllPossibleDataHashes2>>>;
/**
 * Gets point forecast data for given location
 */
export declare const getPointForecastFragmentData: (
  { lat, lon, days, source }: PointForecastOptions,
  includeInQueryString?: IncludeInFragmentQueryString | undefined | null,
  model?: PointProducts | undefined,
  httpOptions?: HttpOptions,
) => Promise<HttpPayload<FragmentDataPayload>>;
/**
 * Loads forecast archive and always resolves
 */
export declare const loadForecastArchive: (
  model: PointProducts,
  selRange: number,
  latLon: LatLon,
  source?: string,
  abortSignal?: AbortSignal,
) => Promise<DataHash2 | null>;
