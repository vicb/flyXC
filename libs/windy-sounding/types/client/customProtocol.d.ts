 ...
 */
export declare function registerCustomTileProtocol(
  protocol: CustomProtocol,
  urlTransformCallback: (url: string, protocol: string) => TransformedUrlPayload,
  tilePreprocessCallback?: TileDataPreprocessCallback,
  fallbackImageData?: ArrayBuffer,
