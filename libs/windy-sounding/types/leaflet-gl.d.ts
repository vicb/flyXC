...
export type SourceSpecification = RasterSourceSpecification;
...
export type LayerSpecification = RasterLayerSpecification | BackgroundLayerSpecification;
 ...
 */
export declare const layerGroup: (layers?: Layer[], options?: LayerOptions) => LayerGroup;
...
export type LatLngLiteralLon = {
  lat: number;
  lon: number;
  alt?: number;
};
export type LatLngLiteralLng = {
  lat: number;
  lng: number;
  alt?: number;
};
export type LatLngLiteral = LatLngLiteralLon | LatLngLiteralLng;
export type LatLngTuple = [number, number, number?];
export type LatLngExpression = LatLng | LatLngLiteral | LatLngTuple;
/**
 * Creates an object representing a geographical point with the given latitude and longitude (and optionally altitude).
 */
declare function toLatLng(latitude: number, longitude: number, altitude?: number): LatLng;
/**
 * Expects an array of the form `[Number, Number]` or `[Number, Number, Number]` instead.
 */
declare function toLatLng(coords: LatLngTuple): LatLng;
/**
 * Expects an plain object of the form `{lat: Number, lng: Number}` or `{lat: Number, lng: Number, alt: Number}` instead.
 * You can also use `lon` in place of `lng` in the object form.
 */
declare function toLatLng(coords: LatLngLiteral): LatLng;
declare function toLatLng(object: LatLng): LatLng;
declare function toLatLng(
  latOrLatLngExpression: LatLng | LatLngLiteral | LatLngTuple | number,
  lng?: number,
  altitude?: number,
): LatLng;
...
declare abstract class IconBase {
  ...
  protected _setIconStyles(
    element: HTMLElement,
    name: IconImgName,
    sizeOption: PointExpression | number,
    anchorOption?: PointExpression | null,
  ): void;
}
export type IconOptions = IconBaseOptions & {
  /**
...
export type IconImgName = 'icon' | 'shadow';
/**
 * @class Icon
 *
...
export type DivIconOptions = IconBaseOptions & {
  /**
...
export declare class DivIcon extends IconBase {
 ...
 * @group Factory Functions
 */
export declare function latLngBounds(points: LatLngExpression[]): LatLngBounds;
/**
 * @deprecated
 ...
 * @group Factory Functions
 */
export declare function latLngBounds(corner1: LatLngExpression, corner2: LatLngExpression): LatLngBounds;
/**
 ...
 */
export declare function template(str: string, data: object): string;
export type MapBounds = [[number, number], [number, number]];
export type LeafletBounds = [LatLngExpression, LatLngExpression] | LatLngBounds;
declare function requestAnimFrame(fn: Function, context?: any): ReturnType<typeof window.requestAnimationFrame>;
declare function create<T extends keyof HTMLElementTagNameMap>(
  tagName: T,
  className?: string,
...
export type CSSScaleAndBoundingRect = {
  x: number;
  y: number;
  boundingClientRect: DOMRect;
};
declare function getCssRectScale(element: HTMLElement): CSSScaleAndBoundingRect;
declare function addClass(el: HTMLElement | SVGElement, name: string): void;
 ...
 * ```
 */
export declare class Draggable extends LeafletEvented {
...
declare class MarkerDrag extends Handler implements IDragHandler {
 ...
 * @group Factory Functions
 */
export declare function marker(latlng: LatLngExpression, options?: MarkerOptions): Marker;
...
export type BoundsExpression = Bounds | PointExpression[] | BoundsObject;
export type BlanketOverlayOptions = LayerOptions & {
  /**
...
declare abstract class BlanketOverlay extends Layer {
...
export type CircleMarkerOptions = PathOptions & {
  /**
 ...
 * @group Factory Functions
 */
export declare function circleMarker(latlng: LatLngExpression, options?: CircleMarkerOptions): CircleMarker;
export type RendererBaseOptions = BlanketOverlayOptions & {
  padding?: number | undefined;
  tolerance?: number | undefined;
};
declare abstract class RendererBase extends BlanketOverlay {
...
export type StyleFunction = (feature?: geojson.Feature) => PathOptions;
export declare abstract class Path extends Layer {
...
export type LatLngExpressionShape = LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][];
export type LatLngShape = LatLng[] | LatLng[][] | LatLng[][][];
export type LatLngExpressionMultiPolygonShape = LatLngExpression[][] | LatLngExpression[][][];
 ...
 * @group Factory Functions
 */
export declare function polyline(latlngs: LatLngExpressionShape, options?: PolylineOptions): Polyline;
export type OverlayContentBase = HTMLElement | string;
export type OverlayContent = OverlayContentBase | ((layer: Layer) => OverlayContentBase);
 ...
 * @group Internal Layers
 */
export declare abstract class DivOverlay extends Layer {
 ...
 * @group Factory Functions
 */
export declare function tooltip(latlng?: LatLngExpression, options?: TooltipOptions): Tooltip;
/**
 * @deprecated
 ...
 * @group Factory Functions
 */
export declare function tooltip(options?: TooltipOptions, source?: Layer): Tooltip;
 ...
 * @group Factory Functions
 */
export declare function popup(options?: PopupOptions, source?: Layer): Popup;
/**
 * @deprecated
 ...
 * @group Factory Functions
 */
export declare function popup(latlng?: LatLngExpression, options?: PopupOptions): Popup;
/**
...
export type LeafletMouseEvent = LeafletEvent & {
  latlng: LatLng;
  layerPoint: Point;
...
export type ErrorEventLeaf = LeafletEvent & {
  message: string;
  code: number;
};
export type LayerEvent = LeafletEvent & {
  layer: Layer;
};
export type LayersControlEvent = LayerEvent & {
  name: string;
};
export type GridLayerTileEvent = LeafletEvent & {
  tile: HTMLElement;
  coords: Coords;
};
export type GridLayerTileErrorEvent = GridLayerTileEvent & {
  error: Error;
};
export type ResizeEvent = LeafletEvent & {
  oldSize: Point;
  newSize: Point;
};
export type PopupEvent = LeafletEvent & {
  popup: Popup;
};
export type TooltipEvent = LeafletEvent & {
  tooltip: Tooltip;
};
export type DragEndEvent = LeafletEvent & {
  distance: number;
};
export type LeafletKeyboardEvent = LeafletEvent & {
  originalEvent: KeyboardEvent & {
    target?: HTMLElement;
  };
};
export type LeafletMoveEvent = LeafletEvent & {
  latlng?: LatLng;
  oldLatLng?: LatLng;
  originalEvent: MouseEvent & {
    target?: HTMLElement;
...
export type TileCacheEvent = LeafletEvent & {
  coords: Coords;
  tile: any;
};
...
export type ErrorEventHandlerFn = (event: ErrorEventLeaf) => void;
...
export type GridLayerTileEventHandlerFn = (event: GridLayerTileEvent) => void;
export type GridLayerTileErrorEventHandlerFn = (event: GridLayerTileErrorEvent) => void;
export type LeafletMoveEventHandlerFn = (event: LeafletMoveEvent) => void;
export type TileCacheEventHandlerFn = (event: TileCacheEvent) => void;
...
export type LeafletGlEventHandlerFnMap = LeafletEventHandlerFnMap & {
...
export type LeafletGpxEventBase = LeafletEvent & {
  attributes: Record<string, string | null>;
};
export type LeafletPointEvent = LeafletGpxEventBase & {
  point: Marker;
};
export type LeafletLineEvent = LeafletGpxEventBase & {
  line: Polyline[];
};
export type LeafletPointEventHandlerFn = (event: LeafletPointEvent) => void;
export type LeafletLineEventHandlerFn = (event: LeafletLineEvent) => void;
declare class LeafletEvented {
  private _events;
...
export type ImageOverLayerStyle = {
  opacity?: number;
};
...
export declare class ImageOverlay extends Layer {
   ...
   */
  setOpacity(opacity: number): this;
  setStyle(styleOpts: { opacity?: number }): this;
  /**
 ...
 * @group Factory Functions
 */
export declare function imageOverlay(
  url: string,
  bounds: LatLngBoundsExpression,
  options?: ImageOverlayOptions,
): ImageOverlay;
export type LayerStyle = PopupOptions | StyleFunction | ImageOverLayerStyle | PathOptions;
 ...
 * @group Internal Layers
 */
export declare abstract class Layer extends LeafletEvented {
   ...
   * @internal
   */
  _layerAdd(e: { target: LeafletGlMap }): void;
  /**
   * @internal
   */
  _initOverlay<T extends DivOverlay, O extends DivOverlayOptions>(
    OverlayClass: {
...
export type CanvasPaintSpecification = {
  'raster-opacity'?: number;
};
export type CanvasLayerOptions = LayerOptions & {
  /**
...
declare class MapLibreCanvasLayer extends StyleLayer {
  type: 'canvas';
...
export type RasterPaintSpecification = {
  'raster-opacity'?: number;
};
export type CoordsType = Coords;
export type PreRenderRasterTileCallback = (
  gl: WebGL2RenderingContext | WebGLRenderingContext,
  program: WebGLProgram,
  tileCoords: CoordsType,
  layerId: string,
) => void;
export type PostRenderRasterTileCallback = (
  gl: WebGL2RenderingContext | WebGLRenderingContext,
  tileCoords: CoordsType,
) => void;
export type CustomTileShaderSpec = {
  pixelTransform: string;
};
export type RasterLayerCustomShaderSpecification = RasterLayerSpecification & {
...
export type AddLayerObject =
  ...
  | CustomLayerInterface
  | RasterLayerCustomShaderSpecification
  | MapLibreCanvasLayer;
/**
...
export interface DragMoveHandler<T extends DragMovementResult, E extends Event> extends Handler$1 {
...
declare class TouchPanHandler implements Handler$1 {
  _enabled: boolean;
  _active: boolean;
  _touches: {
...
export type ZoomInOutOptions = AnimationOptions & {
  zoomDelta?: number;
};
/**
...
declare class HandlerManager {
  ...
  handleEvent: (e: Event$1, eventName?: keyof Handler$1) => void;
  mergeHandlerResult(
...
declare abstract class TwoFingersTouchHandler implements Handler$1 {
  _enabled?: boolean;
  _active?: boolean;
 ...
 * @group Handlers
 */
export declare class ScrollZoomHandler implements Handler$1 {
  _map: MapLibreMap;
 ...
 * @group Handlers
 */
export declare class BoxZoomHandler implements Handler$1 {
  _map: MapLibreMap;
  _tr: TransformProvider;
  _el: HTMLElement;
  _container: HTMLElement;
 ...
 **/
export declare class CooperativeGesturesHandler implements Handler$1 {
 ...
 * @group Handlers
 */
export declare class KeyboardHandler implements Handler$1 {
  _tr: TransformProvider;
  _enabled: boolean;
  _active: boolean;
  _panStep: number;
...
declare class ClickZoomHandler implements Handler$1 {
  _tr: TransformProvider;
  _enabled: boolean;
  _active: boolean;
  /** @internal */
...
declare class TapZoomHandler implements Handler$1 {
  _tr: TransformProvider;
  _enabled: boolean;
  _active: boolean;
...
declare class TapDragZoomHandler implements Handler$1 {
  _enabled: boolean;
  _active: boolean;
  _swipePoint: Point;
  _swipeTouch: number;
...
export type DevicePixelRationFlag = {
  /**
...
export type RasterSourceSpecificationWithRetina = RasterSourceSpecification & DevicePixelRationFlag;
/**
...
declare class LayerOrderingRepository {
  private _buckets;
  /**
...
export type CompleteMapOptions = Complete<MapLibreMapOptions>;
 ...
 */
export declare class MapLibreMap extends Camera {
  style: Style;
  painter: Painter;
  handlers: HandlerManager;
  _container: HTMLElement;
...
declare abstract class Control {
  ...
  protected _refocusOnMap(e: { screenX: number; screenY: number }): void;
}
export type MapPaneNameBuiltIn =
  | 'mapPane'
  | 'tilePane'
  | 'overlayPane'
  | 'shadowPane'
  ...
  | 'tooltipPane'
  | 'popupPane';
export type MapPaneName = MapPaneNameBuiltIn | string;
...
export type FitBoundsOptionsLeaf = ZoomOptions &
  PanOptions & {
...
export type DomFirableEventTypes =
  | 'click'
  | 'dblclick'
  | 'mousedown'
  | 'mouseup'
 ...
 * - `markerZoomAnimation`
 */
export type LeafletGlMapOptions = {
  /**
 ...
 * ```
 */
export declare class LeafletGlMap extends LeafletEvented {
   ...
   */
  mouseEventToContainerPoint(e: { clientX: number; clientY: number }): Point;
  /**
   * Given a MouseEvent object, returns the pixel coordinate relative to
   * the origin pixel (see {@link getPixelOrigin}) where the event took place.
   */
  mouseEventToLayerPoint(e: { clientX: number; clientY: number }): Point;
  /**
   * Given a MouseEvent object, returns geographical coordinate where the
   * event took place.
   */
  mouseEventToLatLng(e: { clientX: number; clientY: number }): LatLng;
  /**
...
export type TileLayerOptions = LayerOptions & {
  /**
 ...
 * @group Factory Functions
 */
export declare function tileLayer(url: string, options?: TileLayerOptions): TileLayer;
export type CoordsWithKey = Coords & {
  key: string;
};
/**
 ...
 * @group Tile Management
 */
export declare function wrappedCoords(tilePoint: Coords): Coords;
/**
 * Returns a string representation of the input {@link Coords} that can be used as a key in a dictionary.
 *
 * @group Tile Management
 */
export declare function getCoordsKey(coords: Coords): string;
/**
 ...
 * @group Tile Management
 */
export declare class TileQuadTree<T> {
  private _root;
  /**
   ...
   */
  gatherOrderedRenderable(
    tileBounds: Bounds,
    tileZoom: number,
    maxLowerZoomAllowed: number, // how many lower zoom levels are we allowed to use
    maxHigherZoomAllowed: number,
  ): Coords[];
  /**
...
export type LoadTileFunc<T> = (tile: Coords, abort: AbortSignal) => Promise<T | null>;
export type BeforeTileDeletedFunc<T> = (tile: Coords, data: T | null) => void;
export type AwaitedTile<TTile> =
  | {
      status: 'success';
      tile: TTile;
    }
...
export declare class TileCache<T> extends LeafletEvented {
   ...
   */
  getOrderedTilePyramid(
    tileBounds: Bounds,
    tileZoom: number,
    maxLowerZoomAllowed: number,
    maxHigherZoomAllowed: number,
  ): Coords[];
  /**
 ...
 * @group Layers
 */
export declare class GridLayer<T> extends Layer {
...
export declare function gridLayer<T>(options?: GridLayerOptions): GridLayer<T>;
/**
 ...
 * @group Factory Functions
 */
export declare function featureGroup(layers?: Layer[], options?: LayerOptions): FeatureGroup;
 ...
 * @group Factory Functions
 */
export declare function circle(latlng: LatLngExpression, options?: CircleMarkerOptions): Circle;
/**
 * @deprecated
 ...
 * @group Factory Functions
 */
export declare function circle(latlng: LatLngExpression, radius?: number, options?: CircleMarkerOptions): Circle;
export type RotatedImageOverlayOptions = ImageOverlayOptions & {
  /**
 ...
 * @group Layers
 */
export declare class RotatedImageOverlay extends ImageOverlay {
 ...
 * @group Factory Functions
 */
export declare function polygon(latlngs: LatLngExpressionMultiPolygonShape, options?: PolylineOptions): Polygon;
...
export type ParsedStyle = ParsedOptions & {
  fillColor?: string;
  fillOpacity?: number;
  fill?: boolean;
  icon?: KMLIcon;
 ...
 * @group Layers
 */
export declare class KML extends FeatureGroup {
  ...
  protected _parseLineString(
    line: XMLDocument | Element,
    _xml: XMLDocument | Element,
    options: ParsedStyle,
  ): Polyline | void;
...
declare class KMLIcon extends Icon {
...
export type KMLMarkerOptions = MarkerOptions & {
  icon?: KMLIcon;
};
declare class KMLMarker extends Marker {
 ...
 * @group Factory Functions
 */
export declare function kml(kml: XMLDocument, options?: LayerOptions): KML;
export type SpeedSplitOptions = {
  /**
...
export type GPXOptions = SpeedSplitOptions &
  MarkerOptions &
  PolylineOptions &
  LayerOptions & {
    /**
 ...
 * @group Layers
 */
declare class GpxLayer extends FeatureGroup {
...
export type GraticuleZoomIntervalSettings = {
  start: number;
  end: number;
  interval: number;
};
export type CardinalDirection = 'N' | 'S' | 'E' | 'W';
export type LatLngGraticuleOptions = LayerOptions & {
  /**
 ...
 * @group Layers
 */
export declare class LatLngGraticule extends Layer {
...
declare function on(
  ...
  func: HTMLElementEventHandlerMap[typeof type],
  context: object,
): void;
...
declare function on(
  element: DOMEventTarget,
  types: keyof HTMLElementEventMap | HTMLElementEventHandlerMap | string,
  funcOrContext: Function | object,
  context?: object,
): void;
declare function off(
  element: DOMEventTarget,
  type: keyof HTMLElementEventMap,
  fn: HTMLElementEventHandlerMap[typeof type],
  context?: object,
): void;
 ...
 */
export declare function stamp(obj: object): number;
export declare function falseFn(): false;
type LoadTileFunc$1<T> = (tile: Coords, abort: AbortSignal) => Promise<T | null>;
export type OnTileLoadedFunc<T> = (tile: Coords, data: T) => void;
/**
...
export declare abstract class CanvasTileLayer<TileDataType> extends CanvasLayer {
  ...
  constructor(
    ...
    loadTile: LoadTileFunc$1<TileDataType>,
    tileLoaded?: OnTileLoadedFunc<TileDataType>,
  );
  onAdd(map: LeafletGlMap): this;
  onRemove(map: LeafletGlMap): this;
  redraw(): this;
 ...
 */
export declare function isLatLngArrayFlat(latlngs: LatLng[] | LatLng[][] | LatLng[][][]): latlngs is LatLng[];
export declare function isLatLngArrayFlat(
  latlngs: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][],
): latlngs is LatLngExpression[];
export declare function isLatLngArraySinglyNested(latlngs: LatLng[][] | LatLng[][][]): latlngs is LatLng[][];
export declare function isLatLngArraySinglyNested(
...
declare abstract class CRS {
   ...
   * @returns [min, max]
   */
  get wrapLng(): [number, number] | undefined;
  /**
   * Like `wrapLng`, but for the latitude (vertical) axis.
   * @returns [min, max]
   */
  get wrapLat(): [number, number] | undefined;
  /**
...
declare abstract class EarthClass extends CRS {
  get wrapLng(): [number, number];
  /**
...
export declare const Earth: EarthClass;
declare function simplify(points: Point[], tolerance?: number): Point[];
declare function pointToSegmentDistance(p: Point, p1: Point, p2: Point): number;
declare function squaredDistanceOfClosestPointOnSegment(p: Point, p1: Point, p2: Point): number;
declare function closestPointOnSegment(p: Point, p1: Point, p2: Point): Point;
declare function clipSegment(
  a: Point,
  b: Point,
  bounds: Bounds,
  useLastCode?: boolean,
...
declare function polylineCenter(latlngsRaw: LatLng[] | LatLng[][] | LatLng[][][], crs: CRS): LatLng;
export declare const LineUtil: {
 ...
 * ```
 */
export declare class SVGRenderer extends RendererBase {
...
export declare function svg(options?: RendererBaseOptions): SVGRenderer;
export declare class CanvasRenderer extends RendererBase {
 ...
 * @group Factory Functions
 */
export declare function canvas(options?: RendererBaseOptions): CanvasRenderer;
export declare function isWebGL2(gl: WebGLRenderingContext | WebGL2RenderingContext): gl is WebGL2RenderingContext;
export type CacheAllocationToken<TValue> = {
  value: TValue;
  /**
...
export type GetStringKeyFunc<TKey> = (key: TKey) => string;
export type LoadFunc<TKey, TValue> = (key: TKey, abort: AbortSignal) => Promise<TValue>;
export type DeleteFunc<TValue> = (value: TValue) => void;
/**
 ...
 */
export declare class ReferenceCountedCache<TKey, TValue> {
  private _cache;
   ...
   */
  constructor(
    getStringKeyFunc: GetStringKeyFunc<TKey>,
    loadFunc: LoadFunc<TKey, TValue>,
    deleteFunc?: DeleteFunc<TValue>,
  );
  /**
 ...
 */
export declare function createTileMesh<T extends IndicesType>(
  options: CreateTileMeshOptions,
  forceIndicesSize?: T,
): T extends '32bit'
  ? TileMesh<Uint32Array>
  : T extends '16bit'
  ? TileMesh<Uint16Array>
  : TileMesh<Uint16Array | Uint32Array>;
/**
 * Returns the package version of the library
 * @returns Package version of the library
 */
