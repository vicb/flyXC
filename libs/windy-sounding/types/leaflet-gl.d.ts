...
export type PointExpression = Point | [
	number,
	number
] | number[] | {
	x: number | string;
...
declare function toLatLng(latOrLatLngExpression: LatLng | LatLngLiteral | LatLngTuple | number, lng?: number, altitude?: number): LatLng;
 ...
 * @group Factory Functions
 */
export declare function imageOverlay(url: string, bounds: LatLngBoundsExpression, options?: ImageOverlayOptions): ImageOverlay;
...
export type PreRenderRasterTileCallback = (gl: WebGL2RenderingContext | WebGLRenderingContext, program: WebGLProgram, tileCoords: CoordsType, layerId: string) => void;
export type PostRenderRasterTileCallback = (gl: WebGL2RenderingContext | WebGLRenderingContext, tileCoords: CoordsType) => void;
...
export type MapPaneNameBuiltIn = "mapPane" | "tilePane" | "overlayPane" | "shadowPane" | "markerPane" | "tooltipPane" | "popupPane";
...
export type FitBoundsOptionsLeaf = ZoomOptions & PanOptions & {
...
export type DomFirableEventTypes = "click" | "dblclick" | "mousedown" | "mouseup" | "mouseover" | "mouseout" | "mousemove" | "contextmenu" | "keypress" | "keydown" | "keyup" | "preclick";
/**
...
export type GPXOptions = SpeedSplitOptions & MarkerOptions & PolylineOptions & LayerOptions & {
	/**
...
export declare function isLatLngArrayFlat(latlngs: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][]): latlngs is LatLngExpression[];
export declare function isLatLngArraySinglyNested(latlngs: LatLng[][] | LatLng[][][]): latlngs is LatLng[][];
export declare function isLatLngArraySinglyNested(latlngs: LatLngExpression[][] | LatLngExpression[][][]): latlngs is LatLngExpression[][];
type Projection$1 = {
	/**
...
declare function clipSegment(a: Point, b: Point, bounds: Bounds, useLastCode?: boolean, round?: boolean): Point[] | false;
