...
const airspaces = JSON.parse(readFileSync('asp/airspaces.json'));
...
let geoType = new Set();
let type = new Set();
let icaoClass = new Set();
let limitUnit = new Set();
let limitDatum = new Set();
let country = new Set();
