...
export const activeTrack = createSelector(
  tracks,
  trackIndex,
  (tracks, idx) => (tracks ? tracks[idx] : null),
);
export const activeFixes = createSelector(
  activeTrack,
  track => (track ? track.fixes : null),
);
...
export const isMultiDay = createSelector(
  tracks,
  tracks => {
    if (tracks.length == 0) {
      return false;
...
export const tsOffsets = createSelector(
  tracks,
  trackIndex,
  isMultiDay,
  (tracks, trackIndex, isMultiDay) => {
    if (tracks.length == 0) {
      return [];
    }
...
export const maxLats = createSelector(
  tracks,
  tracks => {
...
export const maxLat = createSelector(
  maxLats,
  lats => Math.max(...lats),
);

export const maxLons = createSelector(
  tracks,
  tracks => {
...
export const maxLon = createSelector(
  maxLons,
  lons => Math.max(...lons),
);

export const minLats = createSelector(
  tracks,
  tracks => {
...
export const minLat = createSelector(
  minLats,
  lats => Math.min(...lats),
);

export const minLons = createSelector(
  tracks,
  tracks => {
...
export const minLon = createSelector(
  minLons,
  lons => Math.min(...lons),
);

export const maxTss = createSelector(
  tracks,
  tsOffsets,
  (tracks, tsOffsets) => {
    const maxTss: number[] = [];
...
export const maxTs = createSelector(
  maxTss,
  tss => (tss.length ? Math.max(...tss) : 1),
);

export const minTss = createSelector(
  tracks,
  tsOffsets,
  (tracks, tsOffsets) => {
    const minTss: number[] = [];
...
export const minTs = createSelector(
  minTss,
  tss => (tss.length ? Math.min(...tss) : 0),
);

export const maxAlts = createSelector(
  tracks,
  tracks => {
...
export const maxAlt = createSelector(
  maxAlts,
  alts => Math.max(...alts),
);

export const minAlts = createSelector(
  tracks,
  tracks => {
...
export const minAlt = createSelector(
  minAlts,
  alts => Math.min(...alts),
);

export const maxSpeeds = createSelector(
  tracks,
  tracks => {
...
export const maxSpeed = createSelector(
  maxSpeeds,
  speeds => Math.max(...speeds),
);

export const minSpeeds = createSelector(
  tracks,
  tracks => {
...
export const minSpeed = createSelector(
  minSpeeds,
  speeds => Math.min(...speeds),
);

export const maxVarios = createSelector(
  tracks,
  tracks => {
...
export const maxVario = createSelector(
  maxVarios,
  varios => Math.max(...varios),
);

export const minVarios = createSelector(
  tracks,
  tracks => {
...
export const minVario = createSelector(
  minVarios,
  varios => Math.min(...varios),
);
