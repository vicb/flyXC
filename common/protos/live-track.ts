...
export interface LiveTrack {
   ...
   *
   * @generated from protobuf field: optional int64 id = 1 [jstype = JS_STRING];
   */
  id?: number;
  /**
   * Only available client side, not stored in the DB.
...
/**
 * Type for protobuf message LiveExtra
 */
...
/**
 * Type for protobuf message LiveTrack
 */
...
/**
 * Type for protobuf message LiveDifferentialTrack
 */
...
/**
 * Type for protobuf message LiveDifferentialTrackGroup
 */
