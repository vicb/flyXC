...
const defaultOutputFile = resolve(join(__dirname, '../../../apps/airspaces/src/assets/airspaces/tiles-info.json'));
const previousInfoFilename = resolve(
  join(__dirname, '../../../apps/airspaces/src/assets/airspaces/tiles-info-previous.json'),
);
