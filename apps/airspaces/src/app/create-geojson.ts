...
const defaultInputFolder = resolve(join(__dirname, '../../../apps/airspaces/src/assets/airspaces'));
const defaultOutputFile = resolve(join(__dirname, '../../../apps/airspaces/src/assets/airspaces/airspaces.geojson'));
