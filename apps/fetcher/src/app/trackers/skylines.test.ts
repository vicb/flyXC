...
describe('Parse Skylines json', () => {
  ...
  test('it should decode tracks crossing midnight UTC', () => {
    ...
    const firstTimestamp = 1602703963;
    // October 14, 2020 4:30:06 PM GMT-07:00
    const lastTimestamp = 1602718206;
    ...
    expect(points[0].timeSec).toBe(firstTimestamp);
    expect(points[points.length - 1].timeSec).toBe(lastTimestamp);
